...
reagent.impl.template.NativeWrapper.cljs$lang$ctorPrWriter = (function (this__16787__auto__,writer__16788__auto__,opt__16789__auto__){
return cljs.core._write.call(null,writer__16788__auto__,"reagent.impl.template/NativeWrapper");
});
...
var G__23258 = o;
(G__23258[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
if(cljs.core.truth_((function (){var and__16196__auto__ = cljs.core.some_QMARK_.call(null,reagent.impl.template.find_dom_node);
if(and__16196__auto__){
var and__16196__auto____$1 = cljs.core.some_QMARK_.call(null,jsprops);
if(and__16196__auto____$1){
var and__16196__auto____$2 = (jsprops["hasOwnProperty"])("onChange");
if(cljs.core.truth_(and__16196__auto____$2)){
...
var vec__23271 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__23271,(0),null);
var id = cljs.core.nth.call(null,vec__23271,(1),null);
var class$ = cljs.core.nth.call(null,vec__23271,(2),null);
...
var jsprops = {"argv": v};
var temp__4661__auto___23274 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__4661__auto___23274 == null)){
} else {
var key_23275 = temp__4661__auto___23274;
(jsprops["key"] = key_23275);
}

return (reagent.impl.util.react["createElement"])(c,jsprops);
});
reagent.impl.template.adapt_react_class = (function reagent$impl$template$adapt_react_class(c){
var G__23277 = (new reagent.impl.template.NativeWrapper());
(G__23277["name"] = c);
...
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__17248__auto__);
});
...
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq23281){
var G__23282 = cljs.core.first.call(null,seq23281);
var seq23281__$1 = cljs.core.next.call(null,seq23281);
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(G__23282,seq23281__$1);
});
...
break;
default:
var G__23286 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,v,(0),cljs.core.subs.call(null,n,(pos + (1))))], null);
v = G__23286;
continue;
...
if((function (){var G__23288 = x;
if(G__23288){
var bit__16882__auto__ = (G__23288.cljs$lang$protocol_mask$partition0$ & (2147483648));
if((bit__16882__auto__) || (G__23288.cljs$core$IPrintWithWriter$)){
return true;
} else {
if((!G__23288.cljs$lang$protocol_mask$partition0$)){
return cljs.core.native_satisfies_QMARK_.call(null,cljs.core.IPrintWithWriter,G__23288);
} else {
return false;
}
}
...
var n__17093__auto___23289 = a.length;
var i_23290 = (0);
while(true){
if((i_23290 < n__17093__auto___23289)){
(a[i_23290] = reagent.impl.template.as_element.call(null,(a[i_23290])));
...
var a = cljs.core.into_array.call(null,s);
var n__17093__auto___23292 = a.length;
var i_23293 = (0);
while(true){
if((i_23293 < n__17093__auto___23292)){
var val_23294 = (a[i_23293]);
if((cljs.core.vector_QMARK_.call(null,val_23294)) && ((reagent.impl.template.key_from_vec.call(null,val_23294) == null))){
(o["no-key"] = true);
} else {
}

(a[i_23293] = reagent.impl.template.as_element.call(null,val_23294));

var G__23295 = (i_23293 + (1));
i_23293 = G__23295;
continue;
} else {
}
...
var ctx = {};
var vec__23297 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__23297,(0),null);
var derefed = cljs.core.nth.call(null,vec__23297,(1),null);
...
var G__23299 = (cljs.core.count.call(null,argv) - first_child);
switch (G__23299) {
case (0):
...
break;
default:
return (reagent.impl.util.react["createElement"]).apply(null,cljs.core.reduce_kv.call(null,((function (G__23299){
