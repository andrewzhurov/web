...
var or__16208__auto__ = (w["requestAnimationFrame"]);
if(cljs.core.truth_(or__16208__auto__)){
return or__16208__auto__;
} else {
var or__16208__auto____$1 = (w["webkitRequestAnimationFrame"]);
if(cljs.core.truth_(or__16208__auto____$1)){
return or__16208__auto____$1;
} else {
var or__16208__auto____$2 = (w["mozRequestAnimationFrame"]);
if(cljs.core.truth_(or__16208__auto____$2)){
return or__16208__auto____$2;
} else {
var or__16208__auto____$3 = (w["msRequestAnimationFrame"]);
if(cljs.core.truth_(or__16208__auto____$3)){
return or__16208__auto____$3;
} else {
...
var n__17093__auto__ = a.length;
var i = (0);
while(true){
if((i < n__17093__auto__)){
var c_23250 = (a[i]);
if((c_23250["cljsIsDirty"]) === true){
(c_23250["forceUpdate"])();
} else {
}
...
var n__17093__auto__ = fs.length;
var i = (0);
while(true){
if((i < n__17093__auto__)){
(fs[i]).call(null);
...
var temp__4661__auto___23253 = (this$["componentQueue"]);
if((temp__4661__auto___23253 == null)){
} else {
var cs_23254 = temp__4661__auto___23253;
(this$["componentQueue"] = null);

reagent.impl.batching.run_queue.call(null,cs_23254);
}
...
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"scheduled?","scheduled?",579986609,null)], null);
});
...
reagent.impl.batching.RenderQueue.cljs$lang$ctorPrWriter = (function (this__16787__auto__,writer__16788__auto__,opt__16789__auto__){
return cljs.core._write.call(null,writer__16788__auto__,"reagent.impl.batching/RenderQueue");
});
